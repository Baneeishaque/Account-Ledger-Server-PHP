...
//$con = new mysqli("localhost", "findandg_ndk", "aA9895204814", "findandg_account_ledger");
$con = new mysqli("localhost", $cpanel_username . "_ndk", "aA9895204814", $cpanel_username . "_account_ledger");
